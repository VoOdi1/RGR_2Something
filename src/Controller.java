...
//Close the input stream
    ...
    public String codeString1 (String input){
        ...
        iterateCodeMatrix1 (matrix, 1, 1, true, 0, input);
    ...
    public String codeString2 (String output){
        ...
        iterateCodeMatrix2 (matrix2, 1, 1, true, 0, output);
    ...
    private void iterateCodeMatrix1 (char[][] matrix1, int x, int y, boolean goRight, int length, String s){
        ...
        if (length == 0){
            ...
            iterateCodeMatrix1(matrix1, x + 1, y, goRight, length + 1, s.substring(1));
        }
        //if last iteration
        ...
        // any other iteration
            ...
            if (goRight){
                ...
                //next iteration
                iterateCodeMatrix1(matrix1, x + length - 2, y - length, !goRight, length + 1, s.substring(length * 2));
            }
            else if (!goRight){
                //go left
    ...
    private void iterateCodeMatrix2 (char[][] matrix2, int y, int x, boolean goRight, int length, String s) {
        int iterator1 = 0;
        char[][] matrix = new char[3][3];
        int x1=0,y1=0;
        for (int i = 0; i < matrix.length; i++){
        ...
        iterateCodeMatrix1(matrix2, y, x+1, goRight, length + 1, s.substring(1));
        }
            ...
            if (goRight) {
                ...
                iterateCodeMatrix1(matrix2, y, x - 1, !goRight, length + 1, s.substring(length * 2));
            }
            else if (!goRight) {
                y1++;
                x1--;
                ...
                x1++;
                matrix2[y1][x1] = matrix[y+1][x];
                iterateCodeMatrix1(matrix2, y , x, goRight, 9, s.substring(6));
